        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <p className="text-amber-200 text-sm uppercase mb-4">
              HOCHWERTIGE NÜSSE FÜR JEDEN GESCHMACK
            </p>
            <h1 className="text-5xl font-bold mb-6 leading-tight">
              Willkommen in der Welt des Nussgenusses!
            </h1>
            <p className="text-lg mb-8 text-amber-100">
              Von knusprigen Mandeln bis zu aromatischen Walnüssen bieten wir
              eine vielfältige Auswahl für jeden Geschmack. Unsere Nüsse sind
              nicht nur ein Snack, sondern eine Geschmacksexpedition. Jede
              Packung ist gefüllt mit der Liebe zur Qualität und dem Streben
              nach höchstem Genuss.
            </p>
            <Link
              href="/shop"
          ...
          <div className="relative">
            <div className="w-full h-96 bg-gradient-to-br from-amber-800 to-amber-900 rounded-lg overflow-hidden">
